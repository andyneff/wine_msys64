# Graphics DO NOT WORK!!!
# If I HAD to wildly guess, wine+mintty+this version libfreetype6 don't work
...
# Combine these when done developing... maybe
RUN dpkg --add-architecture i386; \
    apt-get update; \
    DEBIAN_FRONTEND=noninteractive \
    apt-get install -y \
    # staging-i386 depends
    libasound2:i386 libc6:i386 libglib2.0-0:i386 libglu1-mesa:i386 libgphoto2-6:i386 libgphoto2-port12:i386 libgstreamer-plugins-base1.0-0:i386 libgstreamer1.0-0:i386 liblcms2-2:i386 libldap-2.4-2:i386 libmpg123-0:i386 libopenal1:i386 libpulse0:i386 libudev1:i386 libx11-6:i386 libxext6:i386 libxml2:i386 zlib1g:i386 libasound2-plugins:i386 libncurses5:i386 \
    # staging-i386 recommends
    libcairo2:i386 libcapi20-3:i386 libcups2:i386 libdbus-1-3:i386 libfontconfig1:i386 libgnutls30:i386 libgsm1:i386 libgtk-3-0:i386 libjpeg8:i386 libncurses5:i386 libodbc1:i386 libosmesa6:i386 libpcap0.8:i386 libpng12-0:i386 libsane:i386 libtiff5:i386 libtxc-dxtn-s2tc0:i386 libv4l-0:i386 libva-drm1:i386 libva-x11-1:i386 libva1:i386 libx11-xcb1:i386 libxcomposite1:i386 libxcursor1:i386 libxi6:i386 libxinerama1:i386 libxrandr2:i386 libxrender1:i386 libxslt1.1:i386 libxxf86vm1:i386 \
    # staging-amd64 depends
    libasound2 libc6 libgcc1 libglib2.0-0 libglu1-mesa libgphoto2-6 libgphoto2-port12 libgstreamer-plugins-base1.0-0 libgstreamer1.0-0 liblcms2-2 libldap-2.4-2 libmpg123-0 libopenal1 libpulse0 libudev1 libx11-6 libxext6 libxml2 zlib1g libasound2-plugins libncurses5 \
    # staging-amd64 recommends
    libcairo2 libcapi20-3 libcups2 libdbus-1-3 libfontconfig1 libgnutls30 libgsm1 libgtk-3-0 libjpeg8 libncurses5 libodbc1 libosmesa6 libpcap0.8 libpng12-0 libsane libtiff5 libtxc-dxtn-s2tc0 libv4l-0 libva-drm1 libva-x11-1 libva1 libx11-xcb1 libxcomposite1 libxcursor1 libxi6 libxinerama1 libxrandr2 libxrender1 libxslt1.1 libxxf86vm1 \
    # Font patch
    --force-yes libfreetype6=2.6.1-0.1ubuntu2 libfreetype6:i386=2.6.1-0.1ubuntu2 \
    ; \
    apt-get clean -y

ARG WINEVERSION=2.4.0-3~xenial
RUN build_deps="curl ca-certificates"; \
    ...
    #DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends winehq-staging=2.4.0-3~trusty; \
    DEBIAN_FRONTEND=noninteractive apt-get purge --auto-remove -y ${build_deps}; \
    apt-get clean -y


# # Need apt-transport-https so that I can use an https source. Alternatively, use http
# RUN build_deps="curl ca-certificates"; \
#     apt-get update; \
#     DEBIAN_FRONTEND=noninteractive \
#     apt-get install -y --no-install-recommends \
#                     apt-transport-https ${build_deps}; \
#     apt-key add <(curl -L https://dl.winehq.org/wine-builds/Release.key); \
#     echo 'deb https://dl.winehq.org/wine-builds/ubuntu/ trusty main' > /etc/apt/sources.list.d/wine.list; \
#     dpkg --add-architecture i386; \
#     apt-get update; \
#     DEBIAN_FRONTEND=noninteractive apt-get install -y winehq-staging=2.4.0-3~trusty; \
#     #DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends winehq-staging=2.4.0-3~trusty; \
#     DEBIAN_FRONTEND=noninteractive apt-get purge --auto-remove -y ${build_deps}; \
#     apt-get clean -y
...
# # RUN apt-get update; \
# #     apt-get install --no-install-recommends  fonts-droid libfreetype6 libfreetype6:i386
